...
const NAV_ITEM_CLASS = "flex items-center gap-2 px-4 py-2 text-sm text-gray-600 hover:text-primary transition-colors"
const CATEGORY_ITEM_CLASS = "block py-2 pr-2 text-sm text-gray-600 hover:text-primary transition-colors"
...
export function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 bg-white border-r border-gray-200 z-100">
            ...
            <div>
              {isLoaded && categories.map(cat => (
                <Link
                  ...
                  className={`${CATEGORY_ITEM_CLASS} pl-12 flex items-center gap-2`}
                >
